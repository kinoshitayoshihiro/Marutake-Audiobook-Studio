...
MANIFEST_PATH = ROOT / "reports" / "hayashi_aozora_manifest.json"
DEST_DIR = ROOT / "Reading_library" / "林不忘" / "青空文庫"

USER_AGENT = "GitHub-Copilot/hayashi-aozora-fetcher"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="林不忘の青空本文を取得して整形保存する")
...
def main() -> int:
    ...
    for item in targets:
        ...
        if not title:
            continue
        out_path = DEST_DIR / f"林不忘_{safe_title(title)}.txt"
